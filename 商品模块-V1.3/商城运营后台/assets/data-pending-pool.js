...
(function () {
  ...
  var pendingData = [
    ...
    { id:3, type:'conflict', typeLabel:'渠道冲突', product:'夏季纯棉圆领T恤', brand:'森马', spec:'白色,M', sku:'HZ-A00001-001-DF-A001', channel:'政企福利商城', supplier:'星辰商贸', supplyPrice:'¥85.00', channelPrice:'¥129.00', reason:'渠道 [政企福利商城] 已存在同款在售 (供应链SKU: HZ-A00001-002-DF-A001)', actions:['compare','cancelList'], time:'2026-05-13 16:48:02', sourceType:'清单推品' },
    ...
    { id:5, type:'profit', typeLabel:'利润预警', product:'男士商务休闲皮鞋', brand:'奥康', spec:'黑色,41码', sku:'HZ-A00006-001-DF-A002', channel:'航司积分小站', supplier:'恒通供应链', supplyPrice:'¥100.00', channelPrice:'¥90.00', reason:'供货价 ¥100 > 渠道价 ¥90，预计亏损 ¥10/单', actions:['applyList','cancelList'], time:'2026-05-12 15:12:44', sourceType:'清单推品' },
    ...
    { id:13, type:'conflict', typeLabel:'渠道冲突', product:'不锈钢保温杯500ml', brand:'富光', spec:'银色,500ml', sku:'HZ-A00004-001-DF-A001', channel:'政企福利商城', supplier:'星辰商贸', supplyPrice:'¥34.50', channelPrice:'¥68.00', reason:'渠道 [政企福利商城] 已存在同款在售 (供应链SKU: HZ-A00004-002-DF-A001)', actions:['compare','cancelList'], time:'2026-06-22 11:00:00', sourceType:'清单推品' },
    ...
    { id:15, type:'profit', typeLabel:'利润预警', product:'有机绿茶礼盒装', brand:'八马', spec:'250g礼盒', sku:'HZ-A00021-001-DF-A004', channel:'航司积分小站', supplier:'环球优选', supplyPrice:'¥56.00', channelPrice:'¥48.00', reason:'供货价 ¥56 > 渠道价 ¥48，预计亏损 ¥8/单', actions:['applyList','cancelList'], time:'2026-06-20 13:20:00', sourceType:'清单推品' },
    ...
    { id:24, type:'conflict', typeLabel:'渠道冲突', product:'家用便携式榨汁机', brand:'美的', spec:'白色,600ml', sku:'HZ-A00030-001-DF-A001', channel:'商城会员购', supplier:'星辰商贸', supplyPrice:'¥89.00', channelPrice:'¥159.00', reason:'该商品已在渠道 [商城会员购] 上架在售 (SKU: HZ-A00030-001-DF-A001)，本次为重复推品，请复查是否需改价或调整', actions:['compare','cancelList'], time:'2026-07-29 10:20:00', sourceType:'清单推品' },
    { id:25, type:'conflict', typeLabel:'渠道冲突', product:'每日坚果混合礼盒', brand:'沃隆', spec:'750g礼盒', sku:'HZ-A00031-001-DF-A001', channel:'政企福利商城', supplier:'环球优选', supplyPrice:'¥68.00', channelPrice:'¥128.00', reason:'该商品已在渠道 [政企福利商城] 上架在售 (SKU: HZ-A00031-001-DF-A001)，本次为重复推品，请复查是否需改价或调整', actions:['compare','cancelList'], time:'2026-07-28 15:45:00', sourceType:'清单推品' }
  ];
  ...
  var closedData = [
    ...
    { typeLabel:'利润预警', type:'profit', product:'男士商务休闲皮鞋', brand:'奥康', spec:'黑色,41码', sku:'HZ-A00006-001-DF-A002', channel:'航司积分小站', supplier:'恒通供应链', supplyPrice:'¥100.00', channelPrice:'¥90.00', reason:'供货价 ¥100 > 渠道价 ¥90，预计亏损 ¥10/单', createdTime:'2026-05-12 15:12:44', processedTime:'2026-05-12 15:14:30', method:'申请上架', operator:'王专员', sourceType:'清单推品' },
    ...
    { typeLabel:'渠道冲突', type:'conflict', product:'夏季纯棉圆领T恤', brand:'森马', spec:'白色,M', sku:'HZ-A00001-001-DF-A001', channel:'政企福利商城', supplier:'星辰商贸', supplyPrice:'¥85.00', channelPrice:'¥129.00', reason:'渠道 [政企福利商城] 已存在同款在售 (供应链SKU: HZ-A00001-002-DF-A001)', createdTime:'2026-05-13 16:48:02', processedTime:'2026-05-13 16:50:00', method:'现品改价', operator:'张选品', sourceType:'清单推品' },
