 ...
 * @type {Array<{id: string, name: string, brandName: string, templateId: string, status: 'draft'|'published', createdAt: string}>}
 */
const MOCK_MALLS = [
  { id: 'm1', name: '品牌A美妆旗舰店', brandName: '品牌A - 美妆', templateId: 't1', status: 'published', createdAt: '2025-03-15 14:35' },
  { id: 'm2', name: '品牌B食品商城', brandName: '品牌B - 食品', templateId: 't2', status: 'draft', createdAt: '2025-03-14 11:00' },
  { id: 'm3', name: '品牌C服饰官方店', brandName: '品牌C - 服饰', templateId: 't6', status: 'draft', createdAt: '2025-03-13 09:20' },
  { id: 'm4', name: '品牌D美妆专营店', brandName: '品牌D - 美妆', templateId: 't8', status: 'draft', createdAt: '2025-03-12 16:00' },
  { id: 'm5', name: '品牌E综合商城', brandName: '品牌E - 综合', templateId: 't11', status: 'draft', createdAt: '2025-03-10 10:15' },
  { id: 'm6', name: '美妆品牌标准店', brandName: '品牌A - 美妆', templateId: 't10', status: 'draft', createdAt: '2025-03-08 18:30' },
  { id: 'm7', name: '食品生鲜直营店', brandName: '品牌B - 食品', templateId: 't2', status: 'draft', createdAt: '2025-03-05 14:00' },
];
